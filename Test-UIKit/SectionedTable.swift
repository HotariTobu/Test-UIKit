...
struct SectionedTableView: UIViewControllerRepresentable {
    func makeUIViewController(context: Context) -> SectionedTableViewController {
        SectionedTableViewController()
    }
    
    func updateUIViewController(_ uiViewController: SectionedTableViewController, context: Context) {
        
    }
    
    typealias UIViewControllerType = SectionedTableViewController
}

struct SectionedTableView_Preview: PreviewProvider {
    static var previews: some View {
        SectionedTableView()
    }
}

class SectionedTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
